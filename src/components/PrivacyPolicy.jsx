const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p>
        El presente Política de Privacidad establece los términos en que Rural
        Market usa y protege la información que es proporcionada por sus
      ...
      <p className="mt-4">
        ...
        fichero se crea y la cookie sirve entonces...
      </p>
      <p className="mt-4">
      ...
      <p className="mt-4">
        ...
        que son visitadas y su frecuencia...
      </p>
      <p className="mt-4">
        Estas términos y condiciones se han generado en{" "}
        <a
          href="https://www.plantillaterminosycondicionestiendaonline.com"
