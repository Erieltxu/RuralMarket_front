...
const Suborders = () => {
  ...
  if (loading)
    return (
      <p className="text-center text-lg font-medium">Cargando ventas...</p>
    );
  if (error)
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {subOrders.map((sale) => (
            ...
            >
              ...
              <p className="text-gray-700 text-md mb-1">
                Estado: <span className="font-semibold">{sale.status}</span>
              </p>
              <p className="text-gray-700 text-md mb-1">
                Comprado por:{" "}
                <span className="font-semibold">
                  {sale.order_username} ({sale.order_email})
                </span>
              </p>
                ...
                <ul>
                  {productDetails[sale.id].map((product, index) => (
                    <li
                      ...
                      className="text-gray-700 text-md mb-1"
                    >
                      <span className="text-gray-700 text-md mb-1">
                        Producto:
                      </span>{" "}
                      <span className="font-semibold">
