      ...
      {isMenuOpen && (
        <div className="absolute top-16 left-0 w-full bg-white/90 p-2 z-50 transition-all duration-300 ease-in-out">
          ...
          <nav className="font-bold flex flex-col space-y-2 ">
            <Link to="/" className="text-#1a1a1a" onClick={closeMenu}>
              Inicio
            </Link>
            <Link to="/nuestrasemprendedoras" className="text-#1a1a1a">
              Nuestras emprendedoras
            </Link>
            <Link to="/store" className="text-#1a1a1a" onClick={closeMenu}>
              Tienda
            </Link>
            ...
            {loggedIn && userType === "seller" && (
              <Link to="/product" className="text-#1a1a1a" onClick={closeMenu}>
            ...
            <Link to="/contacto" className="text-#1a1a1a" onClick={closeMenu}>
              Contacto
            </Link>
            <UserIcon />
            <Link to="/carrito" onClick={closeMenu}>
