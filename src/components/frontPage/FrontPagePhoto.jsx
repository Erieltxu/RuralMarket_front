      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        <div className="hidden md:block">
          <img
            ...
            className="w-[900px] h-full object-cover rounded-[15px]"
          />
        </div>
        ...
        <div className="flex flex-col justify-center mt-8">
          ...
          <p className="text-gray-700">
            ...
            productos. A través de nuestra plataforma, los consumidores pueden
            descubrir productos auténticos y de calidad, directamente desde las
            áreas rurales. Además, fomentamos el desarrollo sostenible al
            conectar a las emprendedoras con un público más amplio y apoyar las
            economías locales.
          </p>
