        ...
        <div className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg mt-10"> 
            <div className="flex flex-col items-center">
                ...
                <p className="text-center text-gray-700 leading-relaxed mb-6">
                    Bienvenidx a nuestro espacio… un ‘rincón’ en Internet, abierto y accesible, que nos permite visibilizar el trabajo y los productos y servicios que con tanto esmero desarrollamos las mujeres emprendedoras que nos unimos en esta plataforma.
                    <br/><br/>
                    ...
                    <br/><br/>
                    Desde RuralMarket estamos consiguiendo también un espacio que nos une y permite crear redes de colaboración con otras emprendedoras… lo que - estamos seguras - también redunda en un mejor servicio para ti. 
                    <br/><br/>
